...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "web1", primary: true do |web1|
    ...
    web1.vm.provision "shell", path: "provision_httpd.sh", args: "web1"
  end
  ...
  config.vm.define "web2" do |web2|
    ...
    web2.vm.provision "shell", path: "provision_httpd.sh", args: "web2"
  end
  ...
  config.vm.define "web3" do |web3|
    ...
    web3.vm.provision "shell", path: "provision_httpd.sh", args: "web3"
  end
